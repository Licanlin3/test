<template>
	<div class = "msgboard">
		...
		<div class = "say-box">
			...
			<textarea  v-model = "sayWords" @focus = "showLogin" placeholder = "这小地盘儿是你的啦"></textarea>
...
<script>
	...
	import emoji from "@/components/base/emoji"   //引入emoji表情包
	...
	export default {
		...
		metaInfo(){
			return {
				title: "留言 -blog",
				meta: [{vmid: "description",name: "description",content: "留言 "}]
			}
		},
